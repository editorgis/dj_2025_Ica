...
st.set_page_config(page_title="Sistema de Consulta Declaracion Jurada 2025 - ICA demo.v.1.0", page_icon="🏛️", layout="wide")
...
if not st.session_state['autenticado']:
    # Título Principal
    st.markdown("<h1 style='text-align: center; color: #1E3A8A;'>🏛️ SISTEMA DE CONSULTA DECLARACIÓN JURADA 2025 - ICA demo.v.1.0</h1>", unsafe_allow_html=True)
